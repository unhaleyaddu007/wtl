...
h1
{
	...
	<center><h1>Add Student Information</h1></center>
		...
		<tr> 
			...
			<td><input type="text" name="studentClass" id="studentClass" placeholder="Enter Class"  required></td>
		</tr>
		<tr> 
		...
		<tr> 
			<td><label for="studentPerc">Percentage(%)*</label></td>
			<td><input type="number" name="studentPerc" id="studentPerc" placeholder="00.00"  required></td>
		</tr>
		<tr>
