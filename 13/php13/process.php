...
if(isset($_POST["submit"]))
{
    ...
    $perc=$_POST["studentPerc"];

    //reference https://www.tutorialspoint.com/mysqli/mysqli_insert_query.htm
    $sql="insert into student (student_rollno, student_name,student_dept,student_class,student_perc) values ($roll,'$name','$dept','$class',$perc)";

    $result=mysqli_query($conn,$sql);

    if($result)
    {
    	echo "<script>alert(\"Record of $roll inserted suceessfully\");</script>";
